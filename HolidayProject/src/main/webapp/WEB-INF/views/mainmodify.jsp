...
<script>
	...
	function modifyHoliday(seq){
		if (confirm("선택하신 휴가지를 수정하시겠습니까?")){
...
<body>
  ...
  <main>
    <div class="py-5 text-center">
      ...
      <div >
        <h4 class="mb-3"></h4>
        <form action = "/main/update" method="post" class="needs-validation" >
          ...
          <div class="row g-3 flex-direction: column;">
            ...
            <div class="col-sm-6">
              ...
              <select class="form-select" id="sido" name="sido" >
              	<option selected disable hidden>${dto.sido}</option>
                <option>서울특별시</option>
                <option>부산광역시</option>
                <option>광주광역시</option>
                <option>인천광역시</option>
            ...
            <div class="col-12">
              ...
              name="sigungu" placeholder="세부 위치를 입력해주세요." value="${dto.sigungu }">
            ...
            <div class="col-12">
              ...
              placeholder="간략한 설명을 입력해주세요." value="${dto.outline }">
            </div>
           ...
           <div class="mb-3">
            ...
            <div class="col-12">
              ...
              placeholder="이미지 URL을 입력해주세요." value="${dto.image }">
            </div>
          <hr class="my-4">
          ...
          <div class="d-grid gap-2 d-md-flex justify-content-md-end">
			  <button class="btn btn-outline-primary me-md-2" type="submit" onclick="modifyHoliday(${holiday.seq })">수정</button>
